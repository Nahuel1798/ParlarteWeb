            ...
            <div className="flex flex-col md:flex-row">
              ...
              <div className="md:w-2/5 min-h-[250px] relative overflow-hidden">
                <div
                  ...
                  style={{
                    backgroundImage:
                      "url('https://lh3.googleusercontent.com/aida-public/AB6AXuBA56UU1YbgbVqnTOzSsjIEZ2u34IQUfymv7lFR-Q_JiN0NS7poWQt0kcK2nMOYGWdvh-ndoMWO6HNncYwYU1ZMj103yVJ8my5AdQ9UgdI2KwEDL3qfB4mhq1tzMrSNJPY4tlobZWScmsm8Q90IW_BcqiCG09iHbwuKClSZGKA1XpzeoNaLB21mKW_2evkB7QRbpWKAcFubMQXmdv7IOTOb_hcG6n4Ccx3tuEGCuSEauf6B7NqRRD1b')",
                  }}
                />
              </div>
